                            ...
                            {searchedUser ? (
                                <tr className="hover:bg-gray-300 hover:text-gray-800">
                                    ...
                                    <td className="pr-1 pl-1 flex flex-row items-center justify-center pt-2 gap-2">
                                        <button className="text-2xl text-emerald-700" onClick={() => navigate(`/editar-registro-mecanico/${searchedUser.id_registro}`)}>
                                            <LuFileEdit />
                                        </button>
                                    ...
                                    <tr key={index} className="hover:bg-gray-300 hover:text-gray-800">
                                        ...
                                        <td className="flex flex-row items-center justify-center pt-2 gap-2">
                                            {registro.estatus !== 'finalizado' && (
                                                <button className="text-2xl text-emerald-700" onClick={() => navigate(`/editar-registro-mecanico/${registro.id_registro}`)}>
                                                    <LuFileEdit />
                                                </button>
                                            )}
