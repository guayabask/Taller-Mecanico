...
export default function Tabla_Usuarios() {
    ...
    */}
    <div className="w-full flex flex-row justify-end items-center gap-2 m-2">
        <input placeholder="Escriba aqui el folio del vehiculo" className="w-[20rem] p-1 h-fit rounded-lg border-2"/>
        <button className="bg-blue-600 p-2 rounded-lg text-white">Buscar por folio</button>
    </div>
