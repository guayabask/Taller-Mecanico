                        ...
                        <div className="flex flex-wrap">
                            ...
                            <div className="w-full md:w-1/3 flex flex-col px-2">
                                ...
                                <div className='flex flex-row items-center gap-2'>
                                    ...
                                    <label className="bg-red-600 cursor-pointer p-2 font-bold rounded-lg cursor pointer text-white shadow-md shadow-[#4f4f4f] text-center w-fit" onClick={() => HandeDelte(values.id_registro)}>Finalizar trabajo</label>
