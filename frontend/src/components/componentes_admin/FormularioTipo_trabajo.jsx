                                ...
                                <form className="w-full max-w-lg h-[34rem] p-4 bg-white" onSubmit={handleSubmit}>
                                    ...
                                    <div className="flex flex-wrap -mx-3 mb-6">
                                        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                            ...
                                            <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" placeholder="Ingrese el tipo de trabajo" name="tipo" onChange={handleChange} value={values.tipo} />
                                        </div>
